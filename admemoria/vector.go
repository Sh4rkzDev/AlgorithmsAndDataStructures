...
func (vector *Vector) validarPos(pos int) bool {
	//Devuelve true si la posicion esta dentro del rango del vector
	return vector.Largo() > pos && pos >= 0
}
